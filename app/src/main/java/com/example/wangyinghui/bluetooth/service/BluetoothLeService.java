package com.example.wangyinghui.bluetooth.service;
...
import com.example.wangyinghui.bluetooth.utils.CommonUtil;
...
public class BluetoothLeService extends Service {
    ...
    private void broadcastUpdate(final String action,
        ...
        String s = CommonUtil.byte2HexStr(heartRate);
        String data = CommonUtil.print10(s);
        if (data != null ) {
